...
class Snake(tk.Canvas):
    def __init__(self):
        ...
        #each element is 20px wide, this is why the diff is 100-80-60px
    ...
    def create_objects(self):
        # tag helps us to retrieve images from the Canvas
        self.create_text(
            100, 12, text=f"Score: {self.score} (speed: {moves_per_second})", tag="score", fill="#fff", font=10
        )
        ...
        # The one above, or below - with destructuring tuple
